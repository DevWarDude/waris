...
export default function MobileMenu(prop) {
  return (
    <div
      className={`flex transition-all duration-300  flex-col bg-zinc-800 z-0 relative  pb-10 items-center  gap-14 ${!prop.showMenu && "trans"}`}
    >
      ...
      <div className="flex gap-5 items-center">
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 30 30"
          className="h-[25px] w-[25px] fill-current text-white cursor-pointer menu-item"
        >
